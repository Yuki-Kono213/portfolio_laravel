    ...
    <div class="container">
        ...
        <div class="product">
            ...
            <div>　指定したフォルダ内のPDFファイルをリストに表示し、
                ...
                以前の職場でpdfファイルを使用する機会が多く、その都度ファイルを開くより効率的な方法を考えて作りました。<br>
                ※Windows専用
            </div>
            <br>
            <div>C#</div>
        ...
        <div class="product">
            ...
            <div>　起動した日付のWikipediaからデータを取得し、
                ...
                Wikipediaは色々な人が手打ちで入力するため、ガイドラインに沿っていない記述によっては例外処理が発生し、すべての人物を取得できないことが課題です。<br>
                ※Windows専用
            </div>
            <br>
            <div>C#</div>
